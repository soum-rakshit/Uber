...
import { getDistanceTimeService, getAutoCompleteSuggestionsService } from '../services/maps.service.js';
...
export const getCoordinates = async (req, res, next) => {
    ...
    try {
        ...
        res.status(404).json({ message: `Coordinates not found ${error.message}` });
    }
}
